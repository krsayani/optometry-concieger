  ...
  return (
    <footer className="mt-auto bg-primary text-primary-foreground border-t border-white/5">
      <div className="container-page py-12 md:py-20">
        <div className="grid grid-cols-2 gap-8 sm:gap-10 md:gap-12 md:grid-cols-4 lg:grid-cols-5">
          ...
          <div className="space-y-4 col-span-2 lg:col-span-2">
             <Link to="/" className="inline-flex items-center gap-3 mb-1">
                <img
                  ...
                  className="h-11 w-11 md:h-12 md:w-12 rounded-xl object-cover ring-1 ring-white/15"
                />
                <span className="font-serif text-xl md:text-2xl font-semibold tracking-tight text-white leading-[1.15] overflow-visible">
                  Optometry
          ...
          <div className="space-y-4 md:space-y-6 col-span-2 md:col-span-1">
            ...
            <div className="space-y-4">
              <a href="mailto:Admin@optometryconcierge.com" className="text-sm hover:text-accent transition-colors block font-bold break-all">
        ...
        {/* Bottom Bar */}
        <div className="mt-10 md:mt-16 pt-6 md:pt-8 border-t border-primary-foreground/20 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex flex-col sm:flex-row sm:flex-wrap items-start sm:items-center gap-x-6 gap-y-2 text-xs font-semibold uppercase tracking-wider text-white/60">
