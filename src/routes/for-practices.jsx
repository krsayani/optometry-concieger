          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 mb-8 backdrop-blur-sm">
                     <span className="text-[10px] font-black uppercase tracking-[0.2em] text-accent">dr. owned and led</span>
              </div>
              ...
              <p className="mt-6 text-base md:text-lg text-white/80 font-medium leading-relaxed max-w-xl">
                The recruitment alternative with dr. owned and led. Skip the corporate headhunters and access a pre-vetted pipeline of high-retention clinical talent.
              </p>
